class AppTexts{
  ...
  static String advertisingData = 'Данные по рекламным кабинетам';
  ...
  static String enter = 'Войти';
  static String login = 'Логин';
  static String password = 'Пароль';
  static String forgotPassword = 'Забыли пароль?';
  static String googleEnter = 'Войти с помощью Google';
  static String yandexEnter = 'Войти с помощью Яндекс';
  static String registration = 'Зарегистрироваться';
  static String registrationSmall = 'Регистрация';
  ...
  static String partnerPerson = 'Партнер';
  static String alreadyHaveAccount = 'У меня уже есть аккаунт';

  static String post = 'Почта';
  static String email = 'Электронная почта';
